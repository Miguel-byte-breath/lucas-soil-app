...
- **CRS:** EPSG:4326 WGS84
- **EC:** almacenado en mS/m (unidad nativa LUCAS, ISO 11265:1994, extracto 1:5 a 25°C). Se muestra y exporta convertido a µS/cm (× 10).
...
- **EC en mS/m en JSON, µS/cm en UI y Excel** — los valores del JSON canónico LUCAS están en mS/m (unidad nativa ISO 11265:1994, extracto 1:5 a 25°C). Se multiplican × 10 en `ParamPanel.jsx` y en `formatVal()` de `export.js` para mostrar y exportar en µS/cm, coherente con la práctica analítica española (extracto 1:5).
